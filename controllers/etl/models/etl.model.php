...
trait model
{
    ...
    {
        $sql = sprintf('SELECT hp.npi, codes.code, codes.classification, codes.specialization, codes.description FROM nppes_healthcare_provider hp join nppes_taxonomy_codes codes on codes.code = hp.healthcare_provider_taxonomy_code where hp.npi in(%s) ', implode(",", array_keys($npis)));
