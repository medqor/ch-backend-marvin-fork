...
<html>
    ...
    <head>
        ...
        <script>
            var url = "./admin.php?server=<?php echo $server ?>";
        ...
        <?php if (!empty($servers)): ?>
            <div class="navbar navbar-fixed-top navbar-default" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="./admin.php?">Beanstalk console</a>
                    </div>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <?php if ($server): ?>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="./admin.php?">All servers</a></li>
                                        <?php foreach (array_diff($servers, array($server)) as $key => $serverItem): ?>
                                            <li><a href="./admin.php?server=<?php echo $serverItem ?>"><?php echo empty($key) || is_numeric($key) ? $serverItem : $key ?></a></li>
                                        <?php endforeach ?>
                                    </ul>
                                </li>
                            <?php else: ?>
                            ...
                            <?php if ($tube): ?>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="./admin.php?server=<?php echo $server ?>">All Tubes</a></li>
                                        <?php foreach (array_diff($tubes, array($tube)) as $tubeItem): ?>
                                            <li><a href="./admin.php?server=<?php echo $server ?>&tube=<?php echo urlencode($tubeItem) ?>"><?php echo $tubeItem ?></a></li>
                                        <?php endforeach ?>
                                    </ul>
                                </li>
                            <?php elseif ($tubes): ?>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <?php } ?>
                                    <li><a href="./admin.php?action=manageSamples" role="button">Manage samples</a></li>
                                    <li class="divider"></li>
                            ...
                            <?php if (@$config['auth']['enabled']) { ?>
                                <li class="dropdown">
                                    <a target="_blank" href="./admin.php?logout=true">logout <span class="glyphicon glyphicon-log-out" aria-hidden="true"></span></a>
                                </li>
                            <?php } ?>
                            <?php if ($server && !$tube) { ?>
                                <li>
            ...
            <?php else: ?>
                ...
                <?php elseif (!in_array($tube, $tubes)):
                    ...
                    <br><br><a href="./admin.php?server=<?php echo $server ?>"> << back </a>
                <?php else:
                    ?>
