                ...
                <tbody>
                    ...
                    foreach ($servers as $key => $server):
                        ...
                        <tr>
                            ...
                            <?php else: ?>
                                <td  style="white-space: nowrap;"><a href="./admin.php?server=<?php echo $server ?>"><?php echo $label; ?></a></td>
                            <?php endif ?>
                            ...
                            <td><?php if (array_intersect(array($server), $cookieServers)): ?>
                                    <a class="btn btn-xs btn-danger" title="Remove from list" href="./admin.php?action=serversRemove&removeServer=<?php echo $server ?>"><span
